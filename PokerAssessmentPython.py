...
#create a class card method to represent a single playing card 
...
#initialize with a two character string in the form <rank><Suit>
...
class Poker (object):
  def __init__ (self, numHands):
    ...
    #create a list to store total_points
    numCards_in_Hand = 5
